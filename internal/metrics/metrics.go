...
func New() *Registry {
	r := &Registry{
		...
		storageTotal:   deviceGauge("storage_total_bytes", "Total storage of / in bytes"),
		storageFree:    deviceGauge("storage_free_bytes", "Free storage of / in bytes"),
		storageUsed:    deviceGauge("storage_used_bytes", "Used storage of / in bytes"),
